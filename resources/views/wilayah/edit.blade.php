...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit Wilayah') }}</div>

                <div class="card-body">
                    <form action="{{ route('wilayah.edit', $wilayah) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <label for="kode_bm" class="col-md-3 col-form-label">Kode BM</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="kode_bm" id="kode_bm" value="{{ $wilayah->kode_bm }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="no_registrasi" class="col-md-3 col-form-label">No. Registrasi</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="no_registrasi" id="no_registrasi" value="{{ $wilayah->no_registrasi }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="tgl_pemasangan" class="col-md-3 col-form-label">Tanggal Pemasangan</label>
                            <div class="col-md-5">
                                <input type="date" class="form-control" name="tgl_pemasangan" id="tgl_pemasangan" value="{{ $wilayah->tgl_pemasangan }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="tgl_pengecekan" class="col-md-3 col-form-label">Tanggal Pengecekan</label>
                            <div class="col-md-5">
                                <input type="date" class="form-control" name="tgl_pengecekan" id="tgl_pengecekan" value="{{ $wilayah->tgl_pengecekan }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="nama_pekerjaan" class="col-md-3 col-form-label">Nama Pekerjaan</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="nama_pekerjaan" id="nama_pekerjaan" value="{{ $wilayah->nama_pekerjaan }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="province_id" id="province_id" required>
                                    ...
                                    @foreach ($provinsi as $item)
                                        <option {{ $wilayah->province_id == $item->id ? 'selected': '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="city_id" id="city_id" required>
                                    ...
                                    @foreach ($kota as $item)
                                        <option {{ $wilayah->city_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="district_id" id="district_id" required>
                                    ...
                                    @foreach ($kecamatan as $item)
                                        <option {{ $wilayah->district_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="village_id" id="village_id" required>
                                    ...
                                    @foreach ($desa as $item)
                                        <option {{ $wilayah->village_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="uraian_lokasi" rows="3" class="form-control" required>{{ $wilayah->uraian_lokasi }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                Easting (x): <input class="form-control"  id="x" name="x" required="" onkeypress="return isNumberKey(event)" value="{{ $wilayah->x }}">
                            </div>
                            <div class="col-md-4">
                                Northing (y): <input class="form-control"  id="y" name="y" required="" onkeypress="return isNumberKey(event)" value="{{ $wilayah->y }}">
                            </div>
                        </div>
                            ...
                            <div class="col-md-2">
                                <select class="form-control" name="zone_id" id="zone_id" required>
                                    ...
                                    @foreach ($zones as $zone)
                                        <option {{ $wilayah->zone_id == $zone->id ? 'selected' : '' }}  value="{{ $zone->id }}">{{ $zone->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2">
                                <select class="form-control" name="utm_zone_id" id="utm_zone_id" required>
                                    <option value="">pilih</option>
                                    @foreach ($utm_zones as $utm_zone)
                                        <option {{ $wilayah->utm_zone_id == $utm_zone->id ? 'selected' : '' }} value="{{ $utm_zone->id }}">{{ $utm_zone->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="latitude" value="{{ $wilayah->latitude }}" id="latitude" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="longitude" value="{{ $wilayah->longitude }}" id="longitude" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="tinggi_orthometrik" name="tinggi_orthometrik" required onkeypress="return isNumberKey(event)" value="{{ $wilayah->tinggi_orthometrik }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="tinggi_elipsoid" name="tinggi_elipsoid" required onkeypress="return isNumberKey(event)" value="{{ $wilayah->tinggi_elipsoid }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="file" accept="image/*" class="form-control" name="sketsa" id="sketsa">
                                <span><i>kosongkan jika tidak ubah file</i></span>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="file" accept="image/*" class="form-control" name="gambar" id="gambar">
                                <span><i>kosongkan jika tidak ubah file</i></span>
                            </div>
                        </div>
